      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-20 right-4 z-50 w-[350px] max-h-[400px] sm:w-[350px] sm:max-h-[400px] max-sm:inset-0 max-sm:w-full max-sm:max-h-full max-sm:bottom-0 max-sm:right-0 border border-border-default bg-bg-surface rounded-lg overflow-hidden flex flex-col"
          >
            {/* Header */}
